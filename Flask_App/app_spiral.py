...
def upload():
    if request.method == 'POST':
        ...
        model = pickle.loads(open(r"C:\Users\Dell\OneDrive\Desktop\Flask\Detecting_Parkinson_Disease_Using_ML-main\Flask_App\Training\parkinsonspiral.pkl", "rb").read())
